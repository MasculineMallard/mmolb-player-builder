            ...
            <div className="grid gap-3 px-4 py-4 text-sm text-muted-foreground">
              ...
              <section className="rounded-lg border border-border bg-background/45 p-4">
                ...
                <ul className="list-disc space-y-1.5 pl-5">
                  ...
                  <li><strong className="text-foreground">Bars and yellow glow:</strong> OPS bars reach full width at 1.000 while the real value remains visible. The row glows yellow at OPS &gt; 1.000, OBP ≥ .400, SLG ≥ .600, or SO% ≤ 10.0%.</li>
                </ul>
